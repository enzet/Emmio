"""User-related Emmio data.

It contains all user configurations and data generated by the user:
  - learnings,
  - lexicon checking,
  - listening.
"""
...
class UserData:
    ...
    def get_lexicons_by_language(self, language: Language) -> list[Lexicon]:
        """Get all lexicon checking for the specified language."""
    ...
    def is_known_or_not_a_word(self, word: str, language: Language) -> bool:
        """Check if the word is known or not a word."""
    ...
    def get_word_status(
        ...
        """Get word status in user lexicons."""
    ...
    def get_sessions_and_records(self) -> list[tuple[Session, list[Record]]]:
        ...
        sessions: list[Session] = self.get_sessions()
